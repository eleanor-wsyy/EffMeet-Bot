...
chcp 65001 >nul
title EffMeet begin_experiment.ps1
echo Calling scripts\begin_experiment.ps1 ...
echo.
...
echo   powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\begin_experiment.ps1"
echo.
pause
exit /b !EXITCODE!
